...
var role = true;
var table_id = loading_list_table_id
var filter_id = $("#id_order_customer,#id_order_company")
var to_center = "_all" 
var invisible_columns = [0]
var order_false = [-1,2,3]
var url = loading_list_url
var columns = [
...
var role = true;
var table_id = customer_loading_list_url
var filter_id = $("#id_order_customer,#id_order_company")
var to_center = "_all" 
var invisible_columns = [0]
var order_false = [-1,2,3]
var url = customer_loading_list_table_id
var columns = [
    // data: json key from prepare_results, name: model field name
    { data: 'loading_id', name: 'loading_id' },
    { data: 'orders', name: 'orders' },
